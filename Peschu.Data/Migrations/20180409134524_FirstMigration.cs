    ...
    public partial class FirstMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArticleResource", x => new { x.ArticleId, x.ResourceId });
                    table.ForeignKey(
                        name: "FK_ArticleResource_Articles_ArticleId",
                        column: x => x.ArticleId,
                        principalTable: "Articles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ArticleResource_Resources_ResourceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArticleResource_ResourceId",
